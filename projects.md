...
<section id="one">
	<div class="inner">
		<header class="major">
			<h1 class="portfolio-title">Projects<a href="https://github.com/flaxinger" class="icon fa-github portfolio-icon"></a></h1>
		</header>
...
<div id="googler" class="project-container">
    <!-- Content -->
    <h2 class="project-header project-header-title">Googler</h2>
